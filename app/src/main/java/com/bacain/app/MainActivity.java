...
public class MainActivity extends AppCompatActivity {
    ...
    private void prepareAndShowDocument(@NonNull final Uri uri) {
        ...
        if (PSPDFKit.isOpenableUri(this, uri)) {
            ...
            final DownloadRequest request = new DownloadRequest.Builder(this).uri(uri).build();
    ...
    private void prepareAndShowDemoDocument() {
        ...
        this.documentExtraction =
                ExtractAssetTask.extractAsync(DEMO_DOCUMENT_ASSET_NAME, this)
    ...
    private void launchPdfActivity(@NonNull final Uri uri) {
        ...
        final PdfActivityConfiguration pspdfkitConfiguration =
                new PdfActivityConfiguration.Builder(getApplicationContext())
        ...
        final Intent intent =
                PdfActivityIntentBuilder.fromUri(MainActivity.this, uri)
